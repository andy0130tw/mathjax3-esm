...
var SVGmtr = (function (_super) {
    ...
    SVGmtr.kind = MmlMtr.prototype.kind;
    return SVGmtr;
}(CommonMtrMixin(SVGWrapper)));
export { SVGmtr };
var SVGmlabeledtr = (function (_super) {
    ...
    SVGmlabeledtr.kind = MmlMlabeledtr.prototype.kind;
    return SVGmlabeledtr;
}(CommonMlabeledtrMixin(SVGmtr)));
export { SVGmlabeledtr };
