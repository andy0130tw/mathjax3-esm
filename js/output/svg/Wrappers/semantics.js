...
var SVGsemantics = (function (_super) {
    ...
    SVGsemantics.kind = MmlSemantics.prototype.kind;
    return SVGsemantics;
}(CommonSemanticsMixin(SVGWrapper)));
export { SVGsemantics };
var SVGannotation = (function (_super) {
    ...
    SVGannotation.kind = MmlAnnotation.prototype.kind;
    return SVGannotation;
}(SVGWrapper));
export { SVGannotation };
var SVGannotationXML = (function (_super) {
    __extends(SVGannotationXML, _super);
    function SVGannotationXML() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SVGannotationXML.kind = MmlAnnotationXML.prototype.kind;
...
var SVGxml = (function (_super) {
    ...
    SVGxml.kind = XMLNode.prototype.kind;
