...
var SVGmunder = (function (_super) {
    ...
    SVGmunder.kind = MmlMunder.prototype.kind;
    SVGmunder.useIC = true;
    return SVGmunder;
}(CommonMunderMixin(SVGmsub)));
export { SVGmunder };
var SVGmover = (function (_super) {
    ...
    SVGmover.kind = MmlMover.prototype.kind;
    SVGmover.useIC = true;
    return SVGmover;
}(CommonMoverMixin(SVGmsup)));
export { SVGmover };
var SVGmunderover = (function (_super) {
    ...
    SVGmunderover.kind = MmlMunderover.prototype.kind;
    SVGmunderover.useIC = true;
    return SVGmunderover;
}(CommonMunderoverMixin(SVGmsubsup)));
export { SVGmunderover };
