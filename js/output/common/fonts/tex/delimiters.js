import { V, H } from '../../FontData.js';
export var HDW1 = [.75, .25, .875];
export var HDW2 = [.85, .349, .667];
export var HDW3 = [.583, .082, .5];
export var VSIZES = [1, 1.2, 1.8, 2.4, 3];
var DELIM2F = { c: 0x2F, dir: V, sizes: VSIZES };
var DELIMAF = { c: 0xAF, dir: H, sizes: [.59], stretch: [0, 0xAF], HDW: [.59, -0.544, .5] };
var DELIM2C6 = { c: 0x2C6, dir: H, sizes: [.517, .817, 1.335, 1.777, 1.909] };
var DELIM2DC = { c: 0x2DC, dir: H, sizes: [.583, .805, 1.33, 1.773, 1.887] };
var DELIM2013 = { c: 0x2013, dir: H, sizes: [.5], stretch: [0, 0x2013], HDW: [.285, -0.248, .5] };
var DELIM2190 = { c: 0x2190, dir: H, sizes: [1], stretch: [0x2190, 0x2212], HDW: HDW3 };
var DELIM2192 = { c: 0x2192, dir: H, sizes: [1], stretch: [0, 0x2212, 0x2192], HDW: HDW3 };
var DELIM2194 = { c: 0x2194, dir: H, sizes: [1], stretch: [0x2190, 0x2212, 0x2192], HDW: HDW3 };
var DELIM21A4 = { c: 0x21A4, dir: H, stretch: [0x2190, 0x2212, 0x2223], HDW: HDW3, min: 1.278 };
var DELIM21A6 = { c: 0x21A6, dir: H, sizes: [1], stretch: [0x2223, 0x2212, 0x2192], HDW: HDW3 };
var DELIM21D0 = { c: 0x21D0, dir: H, sizes: [1], stretch: [0x21D0, 0x3D], HDW: HDW3 };
var DELIM21D2 = { c: 0x21D2, dir: H, sizes: [1], stretch: [0, 0x3D, 0x21D2], HDW: HDW3 };
var DELIM21D4 = { c: 0x21D4, dir: H, sizes: [1], stretch: [0x21D0, 0x3D, 0x21D2], HDW: HDW3 };
var DELIM2212 = { c: 0x2212, dir: H, sizes: [.778], stretch: [0, 0x2212], HDW: HDW3 };
var DELIM2223 = { c: 0x2223, dir: V, sizes: [1], stretch: [0, 0x2223], HDW: [.627, .015, .333] };
var DELIM23DC = { c: 0x23DC, dir: H, sizes: [.778, 1], schar: [0x2322, 0x2322], stretch: [0xE150, 0xE154, 0xE151],
    HDW: [.32, .2, .5] };
var DELIM23DD = { c: 0x23DD, dir: H, sizes: [.778, 1], schar: [0x2323, 0x2323], stretch: [0xE152, 0xE154, 0xE153],
    HDW: [.32, .2, .5] };
var DELIM23DE = { c: 0x23DE, dir: H, stretch: [0xE150, 0xE154, 0xE151, 0xE155], HDW: [.32, .2, .5], min: 1.8 };
var DELIM23DF = { c: 0x23DF, dir: H, stretch: [0xE152, 0xE154, 0xE153, 0xE156], HDW: [.32, .2, .5], min: 1.8 };
var DELIM27E8 = { c: 0x27E8, dir: V, sizes: VSIZES };
var DELIM27E9 = { c: 0x27E9, dir: V, sizes: VSIZES };
var DELIM2906 = { c: 0x2906, dir: H, stretch: [0x21D0, 0x3D, 0x2223], HDW: HDW3, min: 1.278 };
var DELIM2907 = { c: 0x2907, dir: H, stretch: [0x22A8, 0x3D, 0x21D2], HDW: HDW3, min: 1.278 };
