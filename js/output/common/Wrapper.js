...
import { TextNode, indentAttributes } from '../../core/MmlTree/MmlNode.js';
...
var CommonWrapper = (function (_super) {
    ...
    function CommonWrapper(factory, node, parent) {
        ...
        _this.stretch = NOSTRETCH;
        _this.font = null;
        _this.parent = parent;
        _this.font = factory.jax.font;
        _this.bbox = BBox.zero();
        _this.getStyles();
        _this.getVariant();
        _this.getScale();
        _this.getSpace();
        _this.childNodes = node.childNodes.map(function (child) {
            ...
            if (wrapped.bbox.pwidth && (node.notParent || node.isKind('math'))) {
                _this.bbox.pwidth = BBox.fullWidth;
            }
            return wrapped;
        });
        return _this;
    ...
    CommonWrapper.prototype.getBBox = function (save) {
        ...
        var bbox = (save ? this.bbox : BBox.zero());
    ...
    CommonWrapper.prototype.getStyles = function () {
        ...
        if (!styleString)
            return;
        var style = this.styles = new Styles(styleString);
    ...
    CommonWrapper.prototype.getAlignShift = function () {
        var _a;
        var _b = (_a = this.node.attributes).getList.apply(_a, __spread(indentAttributes)), indentalign = _b.indentalign, indentshift = _b.indentshift, indentalignfirst = _b.indentalignfirst, indentshiftfirst = _b.indentshiftfirst;
