...
import { MathJax as MJGlobal } from './global.js';
var CONFIG = MJGlobal.config.loader;
...
var Package = (function () {
    ...
    Package.resolvePath = function (name, addExtension) {
        ...
        var file = CONFIG.source[name] || name;
    ...
    Package.prototype.makeDependencies = function () {
        ...
        if (CONFIG.dependencies.hasOwnProperty(name)) {
            dependencies.push.apply(dependencies, __spread(CONFIG.dependencies[name]));
        }
        else if (name !== 'core') {
    ...
    Package.prototype.provides = function (names) {
        ...
        try {
            for (var names_1 = __values(names), names_1_1 = names_1.next(); !names_1_1.done; names_1_1 = names_1.next()) {
                ...
                if (!provided) {
                    if (!CONFIG.dependencies[name_1]) {
                        CONFIG.dependencies[name_1] = [];
                    }
                    CONFIG.dependencies[name_1].push(name_1);
