...
var MmlMmultiscripts = (function (_super) {
    ...
    MmlMmultiscripts.defaults = __assign({}, MmlMsubsup.defaults);
    return MmlMmultiscripts;
}(MmlMsubsup));
export { MmlMmultiscripts };
var MmlMprescripts = (function (_super) {
    ...
    MmlMprescripts.defaults = __assign({}, AbstractMmlNode.defaults);
    return MmlMprescripts;
}(AbstractMmlNode));
export { MmlMprescripts };
var MmlNone = (function (_super) {
    ...
    MmlNone.defaults = __assign({}, AbstractMmlNode.defaults);
    return MmlNone;
}(AbstractMmlNode));
export { MmlNone };
