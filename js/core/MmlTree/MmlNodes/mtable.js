...
var MmlMtable = (function (_super) {
    ...
    MmlMtable.prototype.setInheritedAttributes = function (attributes, display, level, prime) {
        var e_1, _a;
        try {
            for (var indentAttributes_1 = __values(indentAttributes), indentAttributes_1_1 = indentAttributes_1.next(); !indentAttributes_1_1.done; indentAttributes_1_1 = indentAttributes_1.next()) {
    ...
    MmlMtable.prototype.setChildInheritedAttributes = function (attributes, display, level, prime) {
        ...
        var ralign = split(this.attributes.get('rowalign'));
        try {
