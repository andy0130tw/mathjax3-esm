...
export function ExplorerMathItemMixin(BaseMathItem, toMathML) {
    return (function (_super) {
        ...
        class_1.prototype.explorable = function (document) {
            if (this.state() >= STATE.EXPLORER || this.isEscaped)
                return;
...
export function ExplorerMathDocumentMixin(BaseDocument) {
    ...
    return _a = (function (_super) {
        ...
        _a.OPTIONS = __assign(__assign({}, BaseDocument.OPTIONS), { enrichSpeech: 'shallow', renderActions: expandable(__assign(__assign({}, BaseDocument.OPTIONS.renderActions), { explorable: [STATE.EXPLORER] })), a11y: {
                align: 'top',
...
export function ExplorerHandler(handler, MmlJax) {
...
var allExplorers = {
    ...
    flame: function (doc, node) {
        ...
        return FlameColorer.create(doc, null, node);
    },
    treeColoring: function (doc, node) {
        ...
        return TreeColorer.create.apply(TreeColorer, __spread([doc, null, node], rest));
    }
};
