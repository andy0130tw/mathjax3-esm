...
export { ContentHoverer };
var FlameHoverer = (function (_super) {
    __extends(FlameHoverer, _super);
    function FlameHoverer(document, ignore, node) {
        var _this = _super.call(this, document, new DummyRegion(document), node, function (x) { return _this.highlighter.isMactionNode(x); }, function (x) { }) || this;
        _this.document = document;
        _this.node = node;
        return _this;
    }
