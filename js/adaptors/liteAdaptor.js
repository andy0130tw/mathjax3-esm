...
var LiteAdaptor = (function (_super) {
    ...
    function LiteAdaptor(options) {
        ...
        _this.options = userOptions(defaultOptions({}, CLASS.OPTIONS), options);
        _this.parser = new LiteParser();
        _this.window = new LiteWindow();
        return _this;
    }
    ...
    LiteAdaptor.prototype.clone = function (node) {
        var _this = this;
        var nnode = new LiteElement(node.kind);
    ...
    LiteAdaptor.prototype.split = function (node, n) {
        var text = new LiteText(node.value.slice(n));
...
export { LiteAdaptor };
export function liteAdaptor(options) {
    if (options === void 0) { options = null; }
