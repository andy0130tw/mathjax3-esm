...
export function length2em(length, size, scale, em) {
...
export function emRounded(m, em) {
    if (em === void 0) { em = 16; }
...
export function px(m, M, em) {
    if (M === void 0) { M = -BIGDIMEN; }
    if (em === void 0) { em = 16; }
    m *= em;
    if (M && m < M)
        m = M;
