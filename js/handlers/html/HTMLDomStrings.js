...
import { userOptions, defaultOptions, makeArray } from '../../util/Options.js';
var HTMLDomStrings = (function () {
    ...
    HTMLDomStrings.prototype.getPatterns = function () {
        var skip = makeArray(this.options['skipHtmlTags']);
        var ignore = makeArray(this.options['ignoreHtmlClass']);
        var process = makeArray(this.options['processHtmlClass']);
